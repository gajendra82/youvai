...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  Future<void> _onLoginRequested(
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
                'https://aestheticai.globalspace.in/youvai/dev/public/api/auth/login'),
        body: {
          'email': event.email,
  ...
  Future<void> _onRegisterRequested(
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
            'https://aestheticai.globalspace.in/youvai/dev/public/api/auth/register'),
        body: {
          'name': event.name,
          'email': event.email,
          'password': event.password,
  ...
  Future<void> sendOtp(
    ...
    try {
      final response = await http.post(
        Uri.parse(
            'https://aestheticai.globalspace.in/youvai/dev/public/api/auth/send-otp'),
        body: {
          'mobile': event.phone,
        },
      );
  ...
  Future<void> mobileLogin(
    ...
    try {
      final response = await http.post(
        Uri.parse(
            'https://aestheticai.globalspace.in/youvai/dev/public/api/auth/mobile-login'),
        body: {
          'phone': event.phone,
          'otp': event.otp,
          'mobile': event.phone,
  ...
  Future<void> _googleLogin(GoogleLoginRequested googleLoginRequested,
    ...
    try {
      final response = await http.post(
        Uri.parse(
            'https://aestheticai.globalspace.in/youvai/dev/public/api/auth/google-login'),
        body: {
  ...
  Future<void> logout(LogoutRequested event, Emitter<AuthState> emit) async {
    ...
    try {
      ...
      await http.post(
        Uri.parse(
            'https://aestheticai.globalspace.in/youvai/dev/public/api/auth/logout'),
        headers: {
          'Authorization':
  ...
  Future<void> _updateProfile(UpdateProfileRequested event, Emitter<AuthState> emit) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
            'https://aestheticai.globalspace.in/youvai/dev/public/api/auth/update-profile'),
        headers: {
