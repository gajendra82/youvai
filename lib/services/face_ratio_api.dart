...
class FaceRatioApi {
  ...
  Future<FaceRatioData?> analyzeByImageUrl(String imageUrl,
      {bool draw = false}) async {
    ...
    try {
      ...
      return analyzeByBytes(imgRes.bodyBytes,
          filename: 'image.jpg', draw: draw);
    } catch (_) {
      return null;
    }
  }

  Future<FaceRatioData?> analyzeByBytes(Uint8List bytes,
      {String filename = 'upload.jpg', bool draw = false}) async {
